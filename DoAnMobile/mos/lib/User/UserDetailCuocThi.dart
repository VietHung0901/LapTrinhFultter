...
import 'package:mos/User/NoiDung.dart';
import 'package:mos/User/QuyDinh.dart';
...
class _CuocThiDetailScreenState extends State<CuocThiDetailScreen> {
  ...
  Future<void> _fetchContestDetail() async {
    final response = await httpService
        .get(StringURL().usercuocthi + '/detail/${widget.contestId}');
    try {
                        ...
                        ElevatedButton.icon(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => NoiDungApiPage(contestId: widget.contestId),
                              ),
                            );
                          },
                        ...
                        ElevatedButton.icon(
                          onPressed: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    QuyDinhApiPage(contestId: widget.contestId),
                              ),
                            );
                          },
